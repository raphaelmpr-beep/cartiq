...
export const BRAND_WIKI: BrandWiki[] = [
  ...
  // ─── 10. Teko EV ──────────────────────────────────────────────────────────
  {
    ...
    dbBrand: 'Teko EV',
    name: 'Teko EV',
    tagline: 'Modern lithium LSV brand — Turbo, Trophy & Trophy Plus lineup from $8,495.',
    badges: ['Modern EV Brand', 'LSV Focused', 'LiFePO4 Standard', 'Owner Reports Mixed'],
    summary:
      'Teko EV is an emerging lithium-only LSV brand with the highest listing count of any emerging brand on GolfCartIQ in Florida and Georgia. The 2026 lineup covers three tiers — Turbo ($8,495), Trophy ($9,995), and Trophy Plus / Triumph ($11,995) — all shipping with LiFePO4 packs and Apple CarPlay / Android Auto dashboards. Multiple community sources indicate the carts are OEM-sourced from Tao Motors (China), the same factory that supplies Denago, Raka, and Coleman. Warranty terms are lifetime chassis + 8-year LiFePO4 battery (personal use only) + 2-year parts — parts-only, with no labor or shipping coverage.',
    snapshot: {
      headquarters: 'Not publicly confirmed',
      parentCompany: 'OEM: Tao Motors (China) — per r/golfcarts community reports',
      assemblyLocation: 'China (Tao Motors) — final prep at US dealer network',
      primaryMarket: 'Personal use, neighborhood, LSV-ready buyers',
      priceRange: '$8,495–$11,995 new (2026 MSRP)',
      powerTypes: ['Electric (LiFePO4 Lithium)'],
      warrantyHighlight: 'Lifetime chassis + 8yr LiFePO4 (personal use only) + 2yr parts — parts-only, no labor or shipping. Full terms at tekoev.com/warranty',
    },
    manufacturerVerification: {
      level: 'limited_public',
      notes: 'Teko EV\'s corporate structure and US HQ are not disclosed publicly. r/golfcarts community reporting identifies Tao Motors (China) as the OEM — the same factory behind Denago, Raka, and Coleman. High listing count in FL/GA is confirmed by GolfCartIQ. Warranty claims are sourced from tekoev.com; independent verification of warranty fulfillment is not available.',
    },
    commonModels: [
      { name: 'Teko Turbo', type: 'Personal / LSV (4-Pass)', topSpeed: '19 mph stock / 25 mph unlocked', range: '40–55 mi', msrp: '$8,495', notes: 'Entry lithium model. $199 dealer software unlock raises speed limiter to 25 mph.' },
      { name: 'Teko Trophy', type: 'Personal / LSV (4-Pass)', topSpeed: '25 mph', range: '45–60 mi', msrp: '$9,995', notes: 'Mid-tier — most common configuration in GolfCartIQ listings.' },
      { name: 'Teko Trophy Plus / Triumph', type: 'Personal / LSV (4 or 6-Pass)', topSpeed: '25 mph', range: '50–65 mi', msrp: '$11,995', notes: 'Top trim — larger LiFePO4 pack, upgraded infotainment.' },
    ],
    whatMakesDifferent: [
      '#1 emerging brand by listing count in FL and GA on GolfCartIQ — meaningful dealer presence.',
      'Aggressive 2026 price ladder: $8,495 / $9,995 / $11,995 undercuts most lithium LSVs in the same class.',
      'LiFePO4 chemistry standard across all trims — preferred for longevity and thermal safety vs standard Li-ion.',
      '$199 dealer speed unlock (Turbo) is a documented option — buyers should ask whether the unlock is included.',
      'Lifetime chassis + 8-year battery warranty on paper is among the longest in the segment, but coverage is parts-only.',
    ],
    buyerConfidenceNotes: [
      'Warranty is parts-only — no labor or shipping is covered. Buyers should budget for labor at the dealer.',
      '"Personal use only" restriction on the battery warranty means commercial, rental, or fleet use may void coverage.',
      'OEM appears to be Tao Motors (China) per r/golfcarts — ask the dealer to confirm parts sourcing and cross-parts compatibility with Denago/Raka/Coleman.',
      'Reported owner issues (multiple sources): roof/canopy squeaks over bumps, bouncy front-end ride, Apple CarPlay conflicts with Apple Watch, intermittent no-start on the key fob (firmware update pending), defective charging boxes at delivery, touchscreen dead spots, and soundbar EQ that resets after each shutdown.',
      'Known service point: front A-arms have been reported as a wear/warranty item on early Turbo units — inspect before purchase.',
      'Ask the dealer for the full Teko EV warranty document in writing (not just verbal confirmation) and confirm the labor rate for warranty repairs.',
    ],
    buyerChecklist: STANDARD_CHECKLIST,
    ...
    sources: [
      ...
      { label: 'r/golfcarts — Teko Turbo Lithium Owner Thread', url: 'https://www.reddit.com/r/golfcarts/comments/1qs36j0/new_ride_teko_turbo_lithium/' },
      { label: 'CartFinder — Thinking About a Teko Golf Cart? (2026 pricing)', url: 'https://thecartfinder.com/2026/02/23/thinking-about-a-teko-golf-cart/' },
      { label: 'Solana EV — Teko Golf Cart Reviews', url: 'https://solanaev.com/teko-golf-cart-reviews/' },
      { label: 'Teko Golf Carts Community Forum (Facebook)', url: 'https://www.facebook.com/groups/tekogolfcartscommunityforum/' },
    ],
  ...
  // ─── 11. Verdi ────────────────────────────────────────────────────────────
  {
    ...
    summary:
      'Verdi Motor Inc. is an electric golf cart company based in Norcross, GA, with nearly 20 years of industry experience. Their carts ship standard with a 51.7V 150Ah lithium battery — meaningfully larger than the 105Ah found on most competitors — and feature an 11-inch LED touchscreen display. Models include the S Series and F Series (including the Aspen F6). Manufacturing and assembly location are not publicly disclosed.',
    snapshot: {
      founded: 'c. 2005 (nearly 20 years in operation)',
      headquarters: 'Norcross, GA (5964 Peachtree Corners E, 30071)',
      parentCompany: 'Verdi Motor Inc.',
      ...
      warrantyHighlight: 'Warranty administered through authorized dealers — confirm coverage terms in writing',
    },
    manufacturerVerification: {
      level: 'not_verified',
      notes: 'Verdi Motor Inc. is headquartered at 5964 Peachtree Corners E, Norcross, GA 30071 (770-662-1898). The company is a registered U.S. entity but manufacturing and assembly origin are not publicly disclosed on their website. Warranty and service are dealer-administered.',
    },
    commonModels: [
      { name: 'Verdi S Series 4-Passenger', type: 'Personal / LSV', topSpeed: '25 mph', range: '50–70 mi', msrp: '$12,500–$16,000', notes: '150Ah battery standard; 11" LED touchscreen' },
      { name: 'Verdi F Series / Aspen F6', type: 'Personal / LSV', topSpeed: '25 mph', range: '45–65 mi', msrp: '$15,000–$19,000', notes: 'Latest F Series platform; 6-passenger' },
    ],
    whatMakesDifferent: [
      ...
      '11-inch LED touchscreen display is larger than most competitors in this price range.',
      'Nearly 20 years of golf cart industry experience — more established than typical emerging EV brands.',
      'U.S.-based HQ in Norcross, GA with direct dealer support and parts availability.',
    ],
    buyerConfidenceNotes: [
      'Verdi Motor Inc. is a real, registered company with a physical office in Norcross, GA — more transparency than many emerging brands.',
      'Manufacturing and assembly origin are still not publicly disclosed — ask the dealer where the carts are built.',
      'Parts availability outside the authorized dealer network may be limited — confirm local service capability.',
      'The 150Ah battery advantage is real — but verify warranty terms and labor coverage in writing before purchase.',
    ],
    buyerChecklist: STANDARD_CHECKLIST,
    similarBrands: ['teko-ev', 'venom-ev', 'evolution'],
    sources: [
      { label: 'Verdi Motor Inc. Official Site', url: 'https://www.verdimotor.com' },
