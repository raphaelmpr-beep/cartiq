...
export const CITY_CONFIGS: CityConfig[] = [
  ...
  },
  {
    ...
    state: "GA",
    radiusMiles: 25,
    marketType: "Atlanta suburb",
    title: "Golf Carts For Sale in Woodstock, GA | GolfCartIQ",
    metaDescription: "Browse golf cart listings in Woodstock, GA. Compare Club Car, E-Z-GO, and Yamaha dealer prices with verified specs on GolfCartIQ. Updated daily.",
    h1: "Golf Carts For Sale in Woodstock, GA",
    shortAnswer: "Woodstock is one of the highest-volume golf cart markets in metro Atlanta, anchored by major Club Car and E-Z-GO dealers serving Cherokee County and the northern suburbs. GolfCartIQ tracks verified listings within 25 miles so you can compare prices across Woodstock, Canton, and Roswell dealers in one view.",
    nearbySlugs: ["atlanta-ga", "peachtree-city-ga", "cumming-ga"],
    faqs: [
      { q: "How much does a golf cart cost in Woodstock, GA?", a: "New golf carts from Woodstock dealers typically range from $9,000 to $22,000 depending on brand, seating, and battery type. Used carts in good condition generally sell for $4,000–$13,000." },
      { q: "What brands are available from Woodstock golf cart dealers?", a: "Club Car is the dominant brand in the Woodstock market, with E-Z-GO and Yamaha also well represented. Newer brands like Atlas and Epic are available through select dealers." },
      { q: "Do Woodstock dealers deliver?", a: "Most Woodstock dealers offer delivery throughout Cherokee County and metro Atlanta. Confirm delivery range and cost directly with the dealer before purchasing." },
      { q: "Is lithium or gas better for a Woodstock golf cart?", a: "Lithium electric carts are the most popular choice for Woodstock's suburban neighborhoods — quiet, low maintenance, and no fuel costs. Gas carts are preferred for larger properties or commercial use where range matters." },
    ],
  },
  {
    slug: "lakeland-fl",
    ...
    state: "FL",
    radiusMiles: 25,
    marketType: "Central Florida corridor",
    title: "Golf Carts For Sale in Lakeland, FL | GolfCartIQ",
    metaDescription: "Find golf carts for sale in Lakeland, FL. Compare Club Car, E-Z-GO, and Yamaha dealer listings with verified prices on GolfCartIQ. Updated daily.",
    h1: "Golf Carts For Sale in Lakeland, FL",
    shortAnswer: "Lakeland sits at the center of the I-4 corridor between Tampa and Orlando, making it one of Central Florida's most active golf cart markets. Dealers here serve a mix of residential communities, golf courses, and commercial buyers. GolfCartIQ tracks verified listings within 25 miles of Lakeland.",
    nearbySlugs: ["clearwater-fl", "port-orange-fl", "the-villages-fl"],
    faqs: [
      { q: "How much does a golf cart cost in Lakeland, FL?", a: "New golf carts from Lakeland dealers range from $8,500 to $20,000. Used carts in good condition typically sell for $4,000–$12,000. Club Car and E-Z-GO are the most common brands in the market." },
      { q: "Are there street-legal golf cart requirements in Lakeland?", a: "Florida law requires street-legal golf carts to have headlights, taillights, turn signals, mirrors, seatbelts, and a valid registration. Lakeland follows state LSV requirements for public road use." },
      { q: "What golf cart brands do Lakeland dealers carry?", a: "Club Car is the dominant brand in Lakeland, with E-Z-GO and Yamaha also widely available. Newer lithium brands like Atlas and Venom EV are entering the market." },
      { q: "Can I get a golf cart delivered in Lakeland?", a: "Yes — most Lakeland dealers offer delivery throughout Polk County and the broader Central Florida region. Confirm delivery cost and range before purchasing." },
    ],
  },
  {
    slug: "ocala-fl",
    ...
    state: "FL",
    radiusMiles: 25,
    marketType: "Central Florida equestrian community",
    title: "Golf Carts For Sale in Ocala, FL | GolfCartIQ",
    metaDescription: "Browse golf cart listings in Ocala, FL. Compare prices from Teko EV, Bintelli, and Dach dealers serving Marion County on GolfCartIQ. Updated daily.",
    h1: "Golf Carts For Sale in Ocala, FL",
    shortAnswer: "Ocala's large retirement communities, equestrian estates, and active outdoor lifestyle make it a strong golf cart market in Central Florida. Dealers here carry a mix of new lithium models and used carts suited for both neighborhood and property use. GolfCartIQ tracks listings within 25 miles of Ocala.",
    nearbySlugs: ["the-villages-fl", "wildwood-fl", "lady-lake-fl"],
    faqs: [
      { q: "How much does a golf cart cost in Ocala, FL?", a: "New golf carts from Ocala dealers range from $8,000 to $18,000. Used carts typically sell for $3,500–$11,000 depending on brand, condition, and battery type." },
      { q: "What brands are available from Ocala golf cart dealers?", a: "Teko EV, Bintelli, and Dach are well represented in the Ocala market. Club Car and E-Z-GO are also available through regional dealers serving Marion County." },
      { q: "Is lithium worth it for an Ocala golf cart?", a: "Yes — Ocala's warm climate and year-round use make lithium's zero maintenance and longer lifespan a strong value. Lithium carts also handle the heat better than lead-acid batteries." },
    ],
  },
  {
    slug: "cumming-ga",
    ...
    state: "GA",
    radiusMiles: 25,
    marketType: "Atlanta exurb",
    title: "Golf Carts For Sale in Cumming, GA | GolfCartIQ",
    metaDescription: "Find golf carts for sale in Cumming, GA. Compare Teko EV, Dach, and Epic dealer listings with verified prices on GolfCartIQ. Updated daily.",
    h1: "Golf Carts For Sale in Cumming, GA",
    shortAnswer: "Cumming is one of the fastest-growing communities in Forsyth County, with a growing golf cart market driven by lakefront neighborhoods, golf courses, and active adult communities. GolfCartIQ tracks verified dealer listings within 25 miles of Cumming and the surrounding North Georgia area.",
    nearbySlugs: ["woodstock-ga", "atlanta-ga", "peachtree-city-ga"],
    faqs: [
      { q: "How much does a golf cart cost in Cumming, GA?", a: "New golf carts from Cumming-area dealers range from $9,000 to $20,000. Used carts in good condition typically sell for $4,000–$12,000." },
      { q: "What brands are available near Cumming, GA?", a: "Teko EV, Dach, and Epic are the most common brands in the Cumming market. Club Car and E-Z-GO are available through dealers in nearby Woodstock and Atlanta." },
      { q: "Are golf carts street legal in Forsyth County?", a: "Georgia law allows golf carts on public roads with speed limits of 35 mph or less if the cart is registered, insured, and equipped with required safety equipment including lights, mirrors, and seatbelts." },
    ],
  },
  {
    slug: "tifton-ga",
    ...
    state: "GA",
    radiusMiles: 30,
    marketType: "South Georgia regional hub",
    title: "Golf Carts For Sale in Tifton, GA | GolfCartIQ",
    metaDescription: "Browse golf cart listings in Tifton, GA. Compare Club Car and E-Z-GO dealer prices with verified specs on GolfCartIQ. Updated daily.",
    h1: "Golf Carts For Sale in Tifton, GA",
    shortAnswer: "Tifton is the commercial hub of South Georgia, serving a wide agricultural and residential market across Tift County and surrounding areas. Golf cart dealers here carry Club Car and E-Z-GO inventory suited for both personal and commercial use. GolfCartIQ tracks listings within 30 miles of Tifton.",
    nearbySlugs: ["atlanta-ga", "peachtree-city-ga", "jacksonville-fl"],
    faqs: [
      { q: "How much does a golf cart cost in Tifton, GA?", a: "New golf carts from Tifton dealers range from $8,000 to $18,000. Used carts in good condition typically sell for $3,500–$10,000. Club Car is the dominant brand in the market." },
      { q: "What golf cart brands do Tifton dealers carry?", a: "Club Car and E-Z-GO are the primary brands available from Tifton-area dealers. Both gas and electric models are commonly in stock." },
      { q: "Can I use a golf cart for farm or property use near Tifton?", a: "Yes — many Tifton-area buyers use golf carts for agricultural and large property applications. Gas models are popular for extended range, while electric carts work well for shorter daily routes." },
    ],
  },
  {
    slug: "pensacola-fl",
    ...
    state: "FL",
    radiusMiles: 30,
    marketType: "Gulf Coast beach community",
    title: "Golf Carts For Sale in Pensacola, FL | GolfCartIQ",
    metaDescription: "Find golf carts for sale in Pensacola, FL. Compare Teko EV and other dealer listings with verified prices on GolfCartIQ. Updated daily.",
    h1: "Golf Carts For Sale in Pensacola, FL",
    shortAnswer: "Pensacola's beach communities, military installations, and active retirement neighborhoods make it a growing golf cart market on the Gulf Coast. Dealers here serve Escambia County and the broader western Florida Panhandle. GolfCartIQ tracks verified listings within 30 miles of Pensacola.",
    nearbySlugs: ["panama-city-beach-fl", "clearwater-fl", "jacksonville-fl"],
    faqs: [
      { q: "How much does a golf cart cost in Pensacola, FL?", a: "New golf carts from Pensacola dealers range from $8,000 to $18,000. Used carts typically sell for $3,500–$11,000 depending on brand and condition." },
      { q: "Are golf carts allowed on Pensacola Beach?", a: "Golf carts are permitted on designated roads in the Pensacola Beach area with a valid permit. Street-legal LSVs have broader access. Check with Escambia County for current regulations before operating on public roads." },
      { q: "What brands are available from Pensacola golf cart dealers?", a: "Teko EV is well represented in the Pensacola market. Club Car and E-Z-GO are available through regional dealers serving the Gulf Coast corridor." },
    ],
  },
  {
    ...
    state: "FL",
    radiusMiles: 20,
    marketType: "South Florida coastal community",
    title: "Golf Carts For Sale in Delray Beach, FL | GolfCartIQ",
    metaDescription: "Browse golf cart listings in Delray Beach, FL. Compare Venom EV and other dealer prices with verified specs on GolfCartIQ. Updated daily.",
    h1: "Golf Carts For Sale in Delray Beach, FL",
    shortAnswer: "Delray Beach's active downtown, beach communities, and 55+ neighborhoods make it one of South Florida's strongest golf cart markets. Dealers here specialize in lithium electric carts suited for year-round coastal use. GolfCartIQ tracks verified listings within 20 miles of Delray Beach.",
    nearbySlugs: ["fort-lauderdale-fl", "clearwater-fl", "port-orange-fl"],
    faqs: [
      { q: "How much does a golf cart cost in Delray Beach, FL?", a: "New golf carts from Delray Beach dealers range from $9,000 to $22,000. The market skews toward premium lithium models given the year-round coastal use. Used carts typically sell for $5,000–$14,000." },
      { q: "Are golf carts street legal in Delray Beach?", a: "Florida LSV laws apply in Delray Beach. Street-legal carts with proper registration, lights, mirrors, and seatbelts can operate on roads with speed limits of 35 mph or less." },
      { q: "What brands are popular in Delray Beach?", a: "Venom EV is the dominant brand in the Delray Beach market, reflecting demand for premium lithium electric carts. Club Car and Yamaha are also available through South Florida dealers." },
    ],
  },
  {
    slug: "melbourne-fl",
    ...
    state: "FL",
    radiusMiles: 25,
    marketType: "Space Coast community",
    title: "Golf Carts For Sale in Melbourne, FL | GolfCartIQ",
    metaDescription: "Find golf carts for sale in Melbourne, FL. Compare Teko EV and other dealer listings with verified prices on GolfCartIQ. Updated daily.",
    h1: "Golf Carts For Sale in Melbourne, FL",
    shortAnswer: "Melbourne anchors the Space Coast golf cart market, serving Brevard County's beach communities, golf courses, and active adult neighborhoods. Dealers here carry a mix of new electric carts and used models suited for coastal Florida use. GolfCartIQ tracks verified listings within 25 miles of Melbourne.",
    nearbySlugs: ["port-orange-fl", "clearwater-fl", "the-villages-fl"],
    faqs: [
      { q: "How much does a golf cart cost in Melbourne, FL?", a: "New golf carts from Melbourne dealers range from $8,000 to $18,000. Used carts in good condition typically sell for $3,500–$11,000." },
      { q: "What brands are available from Melbourne golf cart dealers?", a: "Teko EV is the most common brand in the Melbourne market. Club Car, E-Z-GO, and Yamaha are available through regional dealers serving the Space Coast." },
      { q: "Is lithium or lead-acid better for a Melbourne golf cart?", a: "Lithium is the better choice for Melbourne's coastal climate — it handles heat and humidity better than lead-acid and requires no maintenance. The upfront premium pays off in longevity." },
    ],
  },
  {
    ...
    state: "FL",
    radiusMiles: 20,
    marketType: "affluent golf community",
    title: "Golf Carts For Sale in Ponte Vedra Beach, FL | GolfCartIQ",
    metaDescription: "Browse golf cart listings in Ponte Vedra Beach, FL. Compare Verdi and other dealer prices with verified specs on GolfCartIQ. Updated daily.",
    h1: "Golf Carts For Sale in Ponte Vedra Beach, FL",
    shortAnswer: "Ponte Vedra Beach is home to TPC Sawgrass and one of Florida's most golf-centric communities. Demand for premium golf carts is high, with buyers favoring lithium electric models for neighborhood and course use. GolfCartIQ tracks verified listings within 20 miles of Ponte Vedra Beach.",
    nearbySlugs: ["jacksonville-fl", "jacksonville-beach-fl", "st-augustine-fl"],
    faqs: [
      { q: "How much does a golf cart cost in Ponte Vedra Beach?", a: "New golf carts from Ponte Vedra Beach-area dealers range from $9,000 to $22,000. The market skews premium given the community's golf culture and affluent buyer base." },
      { q: "What brands are available near Ponte Vedra Beach?", a: "Verdi is well represented in the Ponte Vedra Beach market. Club Car, E-Z-GO, and Yamaha are available through Jacksonville-area dealers serving St. Johns County." },
      { q: "Are golf carts allowed in Ponte Vedra Beach neighborhoods?", a: "Many Ponte Vedra Beach neighborhoods and planned communities allow golf cart use on private roads. Public road operation requires Florida LSV compliance including registration, lights, and safety equipment." },
    ],
  },
  {
    ...
    state: "FL",
    radiusMiles: 25,
    marketType: "South Florida metro",
    title: "Golf Carts For Sale in Fort Lauderdale, FL | GolfCartIQ",
    metaDescription: "Find golf carts for sale in Fort Lauderdale, FL. Compare Venom EV and other dealer listings with verified prices on GolfCartIQ. Updated daily.",
    h1: "Golf Carts For Sale in Fort Lauderdale, FL",
    shortAnswer: "Fort Lauderdale's dense urban neighborhoods, beach communities, and large 55+ population make it a significant golf cart market in South Florida. Dealers here specialize in compact, lithium-powered carts suited for city and coastal use. GolfCartIQ tracks verified listings within 25 miles of Fort Lauderdale.",
    nearbySlugs: ["delray-beach-fl", "clearwater-fl", "port-orange-fl"],
    faqs: [
      { q: "How much does a golf cart cost in Fort Lauderdale?", a: "New golf carts from Fort Lauderdale dealers range from $9,000 to $22,000. The South Florida market skews toward premium lithium models. Used carts typically sell for $5,000–$14,000." },
      { q: "Are golf carts practical in Fort Lauderdale?", a: "Yes — many Fort Lauderdale neighborhoods, particularly near the beach and in 55+ communities, are well suited for golf cart use. Street-legal LSVs can operate on roads with speed limits of 35 mph or less." },
      { q: "What brands do Fort Lauderdale golf cart dealers carry?", a: "Venom EV is the dominant brand in the Fort Lauderdale market. Club Car, Yamaha, and E-Z-GO are available through South Florida regional dealers." },
    ],
  },
  {
    ...
    state: "FL",
    radiusMiles: 20,
    marketType: "beach community",
    title: "Golf Carts For Sale in Jacksonville Beach, FL | GolfCartIQ",
    metaDescription: "Browse golf cart listings in Jacksonville Beach, FL. Compare dealer prices with verified specs on GolfCartIQ. Updated daily.",
    h1: "Golf Carts For Sale in Jacksonville Beach, FL",
    shortAnswer: "Jacksonville Beach's laid-back coastal lifestyle and compact street grid make it ideal for golf cart ownership. The community's beach access points, restaurants, and shops are all within easy cart range. GolfCartIQ tracks verified listings within 20 miles of Jacksonville Beach.",
    nearbySlugs: ["jacksonville-fl", "ponte-vedra-beach-fl", "st-augustine-fl"],
    faqs: [
      { q: "How much does a golf cart cost in Jacksonville Beach?", a: "New golf carts from Jacksonville Beach-area dealers range from $8,000 to $18,000. Used carts in good condition typically sell for $4,000–$12,000." },
      { q: "Are golf carts allowed on Jacksonville Beach streets?", a: "Jacksonville Beach allows golf carts on certain designated streets. Street-legal LSVs with proper registration and safety equipment have broader access. Check with the City of Jacksonville Beach for current local ordinances." },
      { q: "What should I look for when buying a golf cart near the beach?", a: "Salt air accelerates corrosion — prioritize carts with stainless steel hardware, sealed battery compartments, and aluminum frames. Lithium batteries outperform lead-acid in coastal humidity." },
    ],
  },
];
