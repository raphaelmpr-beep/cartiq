...
export const CITY_CONFIGS: CityConfig[] = [
  {
    ...
    title: "Golf Carts For Sale in The Villages, FL | GolfCartIQ",
    ...
    shortAnswer: "The Villages is one of the largest golf cart markets in the world — with over 100,000 residents and more than 750 miles of cart paths, demand for new and used carts is consistently high. GolfCartIQ tracks verified dealer listings within 15 miles so you can compare prices and deals without driving dealership to dealership.",
  ...
  },
  {
    ...
    title: "Golf Carts For Sale in Wildwood, FL | GolfCartIQ",
    metaDescription: "Find golf carts for sale in Wildwood, FL. Wildwood dealers serve The Villages market — compare prices, warranties, and battery specs on GolfCartIQ.",
    h1: "Golf Carts For Sale in Wildwood, FL",
    shortAnswer: "Wildwood is home to some of the highest-volume golf cart dealers in Florida, strategically located at the gateway to The Villages. Dealers here carry extensive new and used inventory across all major brands. GolfCartIQ indexes listings within 15 miles so you can compare deals across Wildwood, Lady Lake, and The Villages dealers in one view.",
  ...
  },
  {
    ...
    title: "Golf Carts For Sale in Lady Lake, FL | GolfCartIQ",
    metaDescription: "Browse golf cart listings in Lady Lake, FL. Dealers serving The Villages corridor — compare prices, battery types, and warranty coverage on GolfCartIQ.",
    h1: "Golf Carts For Sale in Lady Lake, FL",
    shortAnswer: "Lady Lake borders The Villages and shares the same high-demand golf cart market. Dealers here serve residents of both communities and offer a mix of new lithium models and certified pre-owned carts. GolfCartIQ tracks listings within 15 miles across the Lady Lake–The Villages corridor.",
  ...
  },
  {
    ...
    title: "Golf Carts For Sale in Nocatee, FL | GolfCartIQ",
    metaDescription: "Golf carts for sale near Nocatee, FL. Browse verified dealer listings for this master-planned community near St. Johns County. Compare prices on GolfCartIQ.",
    h1: "Golf Carts For Sale Near Nocatee, FL",
    shortAnswer: "Nocatee is one of Florida's fastest-growing master-planned communities, with an extensive internal cart path network. Golf cart demand has grown alongside the community itself. GolfCartIQ tracks dealer listings within 25 miles — covering dealers in St. Augustine, Jacksonville, and Ponte Vedra who serve Nocatee residents.",
    ...
    faqs: [
      ...
      { q: "Which dealers serve Nocatee?", a: "Dealers in Ponte Vedra Beach, St. Augustine, and Jacksonville commonly deliver to Nocatee. GolfCartIQ shows estimated delivery cost from each dealer to help you find the best total delivered price." },
  ...
  },
  {
    ...
    title: "Golf Carts For Sale in St. Augustine, FL | GolfCartIQ",
    metaDescription: "Find golf carts for sale in St. Augustine, FL. Compare dealer listings with verified prices, battery types, and warranty coverage. Updated daily on GolfCartIQ.",
    h1: "Golf Carts For Sale in St. Augustine, FL",
    shortAnswer: "St. Augustine and surrounding St. Johns County have a growing golf cart market driven by coastal communities, gated neighborhoods, and proximity to Nocatee. GolfCartIQ indexes verified dealer listings within 25 miles, covering dealers in St. Augustine, Ponte Vedra, and the beaches area.",
  ...
  },
  {
    ...
    title: "Golf Carts For Sale in Jacksonville, FL | GolfCartIQ",
    ...
    shortAnswer: "Jacksonville is Northeast Florida's largest metro and a growing golf cart market, driven by coastal communities, gated neighborhoods in St. Johns County, and proximity to Nocatee and Ponte Vedra. GolfCartIQ tracks dealer listings within 25 miles across Duval and St. Johns counties.",
    nearbySlugs: ["nocatee-fl", "st-augustine-fl", "ponte-vedra-fl"],
    faqs: [
      { q: "Where can I buy a golf cart in Jacksonville?", a: "Several dealers operate in and around Jacksonville, including Golf Carts Jacksonville and dealers in the Ponte Vedra / Nocatee corridor. GolfCartIQ shows all verified listings with current prices." },
  ...
  },
  {
    ...
    title: "Golf Carts For Sale in Clearwater, FL | GolfCartIQ",
    ...
    shortAnswer: "Clearwater and the broader Tampa Bay area is one of the highest-volume golf cart markets in Florida. GolfCartIQ indexes hundreds of verified listings from Clearwater-area dealers, covering new lithium models, certified pre-owned carts, and street-legal builds.",
    nearbySlugs: ["tampa-fl", "st-pete-fl", "palm-harbor-fl"],
    faqs: [
      { q: "How much is a golf cart in Clearwater?", a: "New carts from Clearwater dealers typically range from $7,500–$20,000. Used carts in good condition sell for $3,995–$12,000. GolfCartIQ's GolfCartIQ Deal Rating shows how each listing compares to current market comps." },
  ...
  },
  {
    ...
    title: "Golf Carts For Sale in Port Orange, FL | GolfCartIQ",
    metaDescription: "Find golf carts for sale in Port Orange, FL. Compare dealer prices, battery types, and warranties in the Daytona Beach area on GolfCartIQ.",
    h1: "Golf Carts For Sale in Port Orange, FL",
    shortAnswer: "Port Orange sits in the heart of Volusia County's golf cart corridor — between Daytona Beach and New Smyrna Beach — with a mix of retirement communities, coastal neighborhoods, and active golf cart use. GolfCartIQ tracks verified dealer listings within 25 miles.",
    nearbySlugs: ["daytona-beach-fl", "new-smyrna-beach-fl", "deland-fl"],
    faqs: [
      { q: "Which dealers are near Port Orange?", a: "Coastal Golf Carts in Port Orange is a verified GolfCartIQ dealer. Additional dealers in the Daytona Beach and DeLand area are indexed as well." },
  ...
  },
  {
    ...
    title: "Golf Carts For Sale in Panama City Beach, FL | GolfCartIQ",
    metaDescription: "Browse golf cart listings in Panama City Beach, FL. Find beach-area dealers with verified prices and battery specs on GolfCartIQ.",
    h1: "Golf Carts For Sale in Panama City Beach, FL",
    shortAnswer: "Panama City Beach is a popular Gulf Coast golf cart destination — both for permanent residents navigating beach communities and vacation rental properties. GolfCartIQ indexes verified dealer listings within 25 miles covering the PCB and Bay County area.",
  ...
  },
  {
    ...
    title: "Golf Carts For Sale in Peachtree City, GA | GolfCartIQ",
    metaDescription: "Golf carts for sale in Peachtree City, GA — the golf cart capital of Georgia. Compare verified dealer listings with prices and specs on GolfCartIQ.",
    h1: "Golf Carts For Sale in Peachtree City, GA",
    shortAnswer: "Peachtree City is nationally recognized as the golf cart capital of Georgia — with over 100 miles of dedicated cart paths connecting every neighborhood, school, and business in the city. GolfCartIQ tracks verified dealer listings within 25 miles for Peachtree City and the broader Fayette County area.",
  ...
  },
  {
    ...
    radiusMiles: 50,
    marketType: "large metro",
    title: "Golf Carts For Sale in Atlanta, GA | GolfCartIQ",
    ...
    shortAnswer: "Greater Atlanta has a growing golf cart market driven by surrounding planned communities, golf courses, and suburban neighborhoods. GolfCartIQ searches within 50 miles of Atlanta to capture dealers in Woodstock, Peachtree City, Covington, and across the metro area.",
    nearbySlugs: ["peachtree-city-ga", "woodstock-ga", "covington-ga"],
    faqs: [
      { q: "Are there golf cart dealers near Atlanta?", a: "Yes — dealers operate in Woodstock, Peachtree City, Covington, and other Atlanta suburbs. GolfCartIQ indexes listings within 50 miles of the city center to give you broad metro coverage." },
      ...
      { q: "What golf cart brands are available near Atlanta?", a: "E-Z-GO, Club Car, Yamaha, ICON, Bintelli, and Evolution are all available through Atlanta-area dealers. GolfCartIQ's brand filter lets you narrow listings to your preferred brand." },
    ],
  },
];
...
export const BRAND_CONFIGS: BrandConfig[] = [
  {
    slug: "ezgo",
    name: "E-Z-GO",
    title: "E-Z-GO Golf Carts For Sale | GolfCartIQ",
    metaDescription: "Browse E-Z-GO golf cart listings in Florida and Georgia. Compare RXV, TXT, and Express models with verified prices and dealer warranties on GolfCartIQ.",
    h1: "E-Z-GO Golf Carts For Sale in FL & GA",
    shortAnswer: "E-Z-GO is one of the most widely owned golf cart brands in the U.S., known for reliability, dealer network depth, and strong resale value. GolfCartIQ tracks E-Z-GO listings across Florida and Georgia from verified dealers.",
  ...
  },
  {
    slug: "club-car",
    name: "Club Car",
    title: "Club Car Golf Carts For Sale | GolfCartIQ",
    metaDescription: "Browse Club Car golf cart listings in Florida and Georgia. Compare Onward, Tempo, and Precedent models with verified prices on GolfCartIQ.",
  ...
  },
  {
    slug: "yamaha",
    name: "Yamaha",
    title: "Yamaha Golf Carts For Sale | GolfCartIQ",
    metaDescription: "Browse Yamaha golf cart listings in Florida and Georgia. Compare Drive2, Adventurer, and QuieTech models with verified prices on GolfCartIQ.",
  ...
  },
  {
    slug: "icon",
    name: "ICON",
    title: "ICON Golf Carts For Sale in FL & GA | GolfCartIQ",
    metaDescription: "Browse ICON golf cart listings in Florida and Georgia. Compare i40, i60, and i80 models — lithium-standard, street-legal builds. Updated daily on GolfCartIQ.",
  ...
  },
  {
    slug: "evolution",
    name: "Evolution",
    title: "Evolution Golf Carts For Sale | GolfCartIQ",
    metaDescription: "Browse Evolution golf cart listings in Florida and Georgia. Lithium-standard models, Classic, Carrier, and Forester series. Compare prices on GolfCartIQ.",
    ...
    buyerTips: [
      ...
      "Evolution dealers in Florida tend to be well-stocked — compare multiple dealers on GolfCartIQ for pricing.",
  ...
  },
  {
    slug: "venom-ev",
    name: "Venom EV",
    title: "Venom EV Golf Carts For Sale | GolfCartIQ",
    metaDescription: "Browse Venom EV golf cart listings in Florida. Strike, Stealth, and other models with 105Ah Eco Battery standard and 8-year warranty. Compare prices on GolfCartIQ.",
    h1: "Venom EV Golf Carts For Sale in Florida",
    shortAnswer: "Venom EV is a premium lithium golf cart brand that ships all models with a 105Ah LiFePO4 Eco Battery as standard — with an optional 160Ah upgrade. The brand offers an 8-year Eco Battery warranty through authorized dealers, one of the longest battery warranties in the industry. GolfCartIQ has verified Venom EV listings from authorized Florida dealers.",
    ...
    buyerTips: [
      ...
      "Venom EV carts are JS-rendered on some dealer sites — GolfCartIQ has pre-verified listings so you don't have to hunt.",
    ...
    faqs: [
      ...
      { q: "Where can I buy a Venom EV in Florida?", a: "GolfCartIQ has indexed Venom EV listings from authorized dealers in Delray Beach, Fort Lauderdale, Naples, and Ponte Vedra Beach, FL. Use GolfCartIQ's search to find in-stock models near you." },
  ...
  },
  {
    slug: "bintelli",
    name: "Bintelli",
    title: "Bintelli Golf Carts For Sale | GolfCartIQ",
    metaDescription: "Browse Bintelli golf cart listings in Florida and Georgia. Beyond, Beachcomber, and other lithium models — compare prices and dealer warranties on GolfCartIQ.",
  ...
  },
  {
    slug: "epic",
    name: "Epic",
    title: "Epic Golf Carts For Sale | GolfCartIQ",
    metaDescription: "Browse Epic golf cart listings in Florida and Georgia. Compare E40, E60, and E80 models with verified prices and specs on GolfCartIQ.",
    ...
    faqs: [
      ...
      { q: "How does Epic compare to ICON?", a: "Both brands offer lithium-standard models at competitive prices. ICON has a larger dealer footprint nationally; Epic has strong Florida dealer presence. Compare specific models side-by-side on GolfCartIQ for current pricing." },
    ],
  },
  {
    slug: "denago",
    name: "Denago EV",
    title: "Denago EV Golf Carts For Sale | GolfCartIQ",
    metaDescription: "Browse Denago EV golf cart listings in Florida and Georgia. Compare prices, battery specs, and dealer warranties on GolfCartIQ.",
  ...
  },
  {
    slug: "teko-ev",
    name: "Teko EV",
    title: "Teko EV Golf Carts For Sale | GolfCartIQ",
    metaDescription: "Browse Teko EV golf cart listings in Florida and Georgia. LiFePO4 lithium models with lifetime chassis warranty. Compare prices on GolfCartIQ.",
    h1: "Teko EV Golf Carts For Sale in FL & GA",
    shortAnswer: "Teko EV has the highest listing count of any emerging brand on GolfCartIQ in Florida and Georgia. The brand offers a lifetime chassis warranty alongside an 8-year LiFePO4 battery warranty (personal use) and 2-year parts warranty.",
  ...
  },
  {
    slug: "sivo",
    name: "Sivo",
    title: "Sivo Golf Carts For Sale | GolfCartIQ",
    metaDescription: "Browse Sivo golf cart listings in Florida. Bintelli sub-brand launched January 2026 with 8-year EcoBattery warranty. Compare prices on GolfCartIQ.",
  ...
  },
  {
    slug: "dach-vehicles",
    name: "DACH Vehicles",
    title: "DACH Vehicles Golf Carts For Sale | GolfCartIQ",
    metaDescription: "Browse DACH Vehicles golf cart listings in Florida. Orlando-assembled modern EVs distributed through Jeffrey Allen Inc. Compare prices on GolfCartIQ.",
  ...
  },
  {
    slug: "verdi",
    name: "Verdi",
    title: "Verdi Golf Carts For Sale | GolfCartIQ",
    metaDescription: "Browse Verdi golf cart listings in Florida. 150Ah lithium battery standard — more range than most competitors. Compare prices on GolfCartIQ.",
...
export const BATTERY_PAGES: BatteryPageConfig[] = [
  {
    ...
    title: "Golf Cart Battery Guide | Lithium vs Lead-Acid, Chargers & More | GolfCartIQ",
  ...
  },
  {
    ...
    title: "Lithium vs Lead-Acid Golf Cart Batteries: Which Is Better? | GolfCartIQ",
  ...
  {
    slug: "105ah-vs-150ah",
    title: "105Ah vs 150Ah Golf Cart Battery: What's the Difference? | GolfCartIQ",
    metaDescription: "105Ah vs 150Ah lithium golf cart battery comparison. How far will each pack go? Is the range upgrade worth the extra cost? GolfCartIQ breaks it down.",
  ...
  },
  {
    ...
    title: "Does a Used Golf Cart Come With a Charger? | GolfCartIQ",
