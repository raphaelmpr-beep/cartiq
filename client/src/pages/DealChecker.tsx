...
export default function DealChecker() {
  ...
  useEffect(() => {
    setSEO({
      title: "Golf Cart CartCheck",
      description: "Check if a golf cart price is fair before you buy. GolfCartIQ's CartCheck compares your cart against real dealer comps in Florida and Georgia.",
      canonical: "https://golfcartiq.com/deal-checker",
    });
  }, []);
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="mb-6">
          <h1 className="text-xl font-bold">CartCheck</h1>
          <p className="text-sm text-muted-foreground mt-1">Get a private GolfCartIQ analysis on any golf cart listing.</p>
        </div>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 space-y-3 text-sm text-amber-900">
                  <div className="flex gap-2">
                    ...
                    <div>
                      ...
                      <p>GolfCartIQ does not automatically import, scrape, or republish Facebook Marketplace listings. Enter the listing details yourself. GolfCartIQ analyzes the details you provide for your private shopping evaluation. The original listing remains on Facebook and may require Facebook login.</p>
                    </div>
                  </div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-3">
                ...
                <Button type="submit" className="flex-1 gap-2" disabled={mutation.isPending} data-testid="btn-submit-deal-check">
                  {mutation.isPending ? "Analyzing…" : "Get My GolfCartIQ Report"} <ArrowRight className="h-4 w-4" />
                </Button>
              </div>
              {mutation.isError && (
          ...
          <div className="space-y-5" data-testid="deal-check-report">
            <Card className="border-green-200 bg-green-50">
              <CardContent className="pt-5 space-y-2">
                <p className="text-xs font-semibold text-green-700 uppercase tracking-wide">Your Private GolfCartIQ Report</p>
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-sm">
                {[
                  ...
                  ["GolfCartIQ Value", formatPrice(result.cartiqMarketValue ?? result.cartiqEstimatedValue)],
