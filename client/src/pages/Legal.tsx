...
export default function Disclosure() {
  useEffect(() => {
    setSEO({
      title: "GolfCartIQ Disclosure | Listing Sources, Pricing Tools, and Sponsored Placement",
      description:
        "Learn how GolfCartIQ displays golf cart listings, pricing tools, dealer sources, featured placements, and removal requests.",
      canonical: "https://golfcartiq.com/disclosure",
    });
  }, []);

  const navSections = [
    { id: "what-cartiq-is",          label: "What GolfCartIQ Is" },
    ...
    { id: "pricing-tools",           label: "Pricing Tools & GolfCartIQ Deal Ratings" },
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="mb-10">
          ...
          <p className="text-sm text-muted-foreground max-w-2xl leading-relaxed">
            GolfCartIQ is an independent golf cart research, comparison, pricing intelligence, and lead-referral
        ...
        <div className="space-y-12">
          ...
          {/* 1 — What GolfCartIQ is */}
          <Section id="what-cartiq-is" icon={<ShieldCheck className="h-5 w-5" />} title="What GolfCartIQ Is">
            <P>
              GolfCartIQ helps buyers compare golf cart listings, dealer inventory, market pricing signals, battery
              types, features, warranties, delivery options, and seller options. GolfCartIQ is designed to help
              buyers make better-informed decisions before contacting a dealer or seller.
            </P>
            <GreenBox label="GolfCartIQ does not sell golf carts">
              GolfCartIQ does not manufacture, sell, own, broker, finance, warrant, service, deliver, or inspect
              golf carts. GolfCartIQ does not complete transactions on behalf of buyers, dealers, or sellers. Any
          ...
          <Section id="where-listings-come-from" icon={<ExternalLink className="h-5 w-5" />} title="Where Listings Come From">
            <P>
              Listings and dealer information on GolfCartIQ may come from several sources:
            </P>
            <ol className="space-y-2 pl-1 list-none">
              {[
                ...
                "Seller-submitted listings provided directly to GolfCartIQ.",
                "GolfCartIQ-created dealer profiles based on publicly available factual business information.",
              ].map((item, i) => (
                <li key={i} className="flex items-start gap-2">
            ...
            <GreenBox label="We link back to the original source">
              GolfCartIQ links back to the original dealer or seller source where available. GolfCartIQ is a starting
          ...
          <Section id="lead-referral" icon={<Scale className="h-5 w-5" />} title="Research and Lead-Referral Platform">
            <P>
              GolfCartIQ is not a transaction marketplace.
            </P>
            <P>GolfCartIQ does not:</P>
            <Ul items={[
              "Sell golf carts",
            ...
            <P>
              ...
              a lead form through GolfCartIQ, any resulting communication, negotiation, purchase, financing,
              delivery, warranty, service, or title/registration process occurs directly between the buyer
              and the dealer or seller.
            </P>
            <GreenBox label="GolfCartIQ is not a party to the transaction">
              GolfCartIQ may help connect buyers with dealers or sellers, but GolfCartIQ is not a party to the golf
              cart transaction.
            </GreenBox>
          </Section>
          ...
          <Section id="how-we-display" icon={<BookOpen className="h-5 w-5" />} title="How We Display Listings">
            <P>GolfCartIQ may display factual listing information such as:</P>
            ...
            <P>
              GolfCartIQ may normalize formatting for consistency. For example, we may standardize model name
              capitalization, condition labels, market names, or battery categories. GolfCartIQ does not
              intentionally change dealer-stated prices or core listing details. GolfCartIQ may add
              platform-generated labels, GolfCartIQ Deal Ratings, market categories, availability indicators, pricing
          ...
          {/* 5 — Pricing Tools */}
          <Section id="pricing-tools" icon={<AlertCircle className="h-5 w-5" />} title="Pricing Tools and GolfCartIQ Deal Ratings">
            <P>
              GolfCartIQ may provide pricing intelligence tools such as GolfCartIQ Value, GolfCartIQ Deal Ratings, comparable
              listing analysis, market averages, and delivery-adjusted pricing estimates. These tools are
              estimates only.
            </P>
            <Ul items={[
              <>
                <strong className="font-medium text-foreground">GolfCartIQ Value</strong> is an estimated
                fair-market comparison based on available listing data and comparable carts in the GolfCartIQ
              ...
              <>
                ...
                listing appears to compare against similar carts in the GolfCartIQ index at that time.
              </>,
              <>
            ...
            <P>GolfCartIQ pricing tools are not:</P>
            <Ul items={[
          ...
          <Section id="featured-sponsored" icon={<DollarSign className="h-5 w-5" />} title="Featured Listings and Sponsored Placement">
            <P>
              Some listings, dealers, or market placements on GolfCartIQ may be paid, sponsored, promoted, or
            ...
            <P>
              Paid placement may affect where a listing or dealer appears on GolfCartIQ, but it does not allow
              a dealer or seller to hide pricing information, remove buyer-facing disclosures, suppress
              GolfCartIQ Deal Ratings, or override GolfCartIQ's pricing transparency features.
            </P>
            <GreenBox label="Sponsorship does not change the transaction">
              GolfCartIQ may receive compensation from dealers, advertisers, lenders, delivery partners,
              warranty providers, or other third-party partners. Sponsored or featured placement does not
              make GolfCartIQ a party to any golf cart transaction.
            </GreenBox>
          </Section>
          ...
          <Section id="photos-sources" icon={<Camera className="h-5 w-5" />} title="Photos and Source References">
            <P>
              GolfCartIQ respects the intellectual property rights of dealers, sellers, brands, photographers,
              and other rights holders. GolfCartIQ does not claim ownership of third-party dealer or seller
            ...
            <Ul items={[
              ...
              "GolfCartIQ does not download, store, alter, watermark, or rehost third-party listing images unless authorized.",
              "Where a listing references a third-party source, GolfCartIQ links back to the original dealer or seller page when available.",
            ]} />
            <P>
              Dealers, sellers, photographers, brands, or rights holders may request correction, attribution
              review, or removal by contacting GolfCartIQ at{" "}
              <a href="mailto:listings@golfcartiq.com" className="text-green-700 hover:underline font-medium">listings@golfcartiq.com</a>.
            </P>
          </Section>
          ...
          <Section id="copyright" icon={<Scale className="h-5 w-5" />} title="Copyright, Factual Data, and Our Approach">
            <P>
              GolfCartIQ is designed to index and compare factual listing information made publicly available
            ...
            <P>
              GolfCartIQ's goal is to organize factual listing data for research and comparison while avoiding
            ...
            <GreenBox label="GolfCartIQ content">
              GolfCartIQ does not claim ownership of third-party content. GolfCartIQ-created content — including
              platform design, GolfCartIQ Deal Ratings, GolfCartIQ Value estimates, pricing labels, market summaries,
              analytics, badges, and comparison tools — belongs to GolfCartIQ or its licensors.
            </GreenBox>
            <P>
              Dealers, sellers, advertisers, and third parties may not copy, reproduce, display, frame,
              embed, or use GolfCartIQ Deal Ratings, pricing badges, valuation outputs, market analytics, or
              proprietary comparison tools outside the GolfCartIQ platform without written permission.
            </P>
          </Section>

          {/* 9 — Data We Don't Use */}
          <Section id="data-we-dont-use" icon={<Database className="h-5 w-5" />} title="Data We Do Not Use">
            <P>GolfCartIQ is deliberate about what data it does not collect or display.</P>
            <Ul items={[
              "GolfCartIQ does not index or display Facebook Marketplace listings or content from Meta platforms.",
              "GolfCartIQ does not index listings that require a login, private account, paid subscription, or restricted access to view.",
              "GolfCartIQ does not intentionally collect private seller or buyer data from third-party platforms.",
              "GolfCartIQ does not sell, share, or redistribute raw listing data to third parties.",
            ]} />
            <GreenBox label="Current scope">
              GolfCartIQ's current scope is dealer inventory, authorized inventory sources, public-reference
          ...
          <Section id="removal-requests" icon={<Mail className="h-5 w-5" />} title="Removal Requests and Corrections">
            <P>
              ...
              dealer profile, image reference, or other content on GolfCartIQ should be corrected, attributed
            ...
            <Ul items={[
              ...
              "The specific GolfCartIQ listing URL or listing ID",
            ...
            <P>
              ...
              <a href="mailto:listings@golfcartiq.com" className="text-green-700 hover:underline font-medium">
                listings@golfcartiq.com
              </a>. GolfCartIQ will acknowledge requests within 2 business days and will review substantiated
              requests promptly. GolfCartIQ may remove, update, suppress, or correct listings or image
              references while a request is under review.
            </P>
            <P>
              Dealers may also contact GolfCartIQ to claim their profile, authorize inventory display, update
          ...
          <Section id="buyer-responsibility" icon={<UserCheck className="h-5 w-5" />} title="Buyer Responsibility">
            ...
            <GreenBox label="GolfCartIQ is a research tool, not a substitute for due diligence">
              GolfCartIQ is a research and comparison tool. It is not a substitute for buyer due diligence.
            </GreenBox>
          </Section>
          ...
          <Section id="contact" icon={<Mail className="h-5 w-5" />} title="Contact and Affiliations">
            <P>
              GolfCartIQ is independent. GolfCartIQ is not affiliated with, endorsed by, or sponsored by Club Car,
            ...
            <div className="grid sm:grid-cols-3 gap-4 mt-2">
              {[
                { label: "General inquiries", email: "hello@golfcartiq.com" },
                { label: "Listings & corrections", email: "listings@golfcartiq.com" },
                { label: "Dealer & partnerships", email: "dealers@golfcartiq.com" },
              ].map(({ label, email }) => (
